...
public:
    ...
    void setupUi(QWidget *Teacher)
    {
        ...
        Teacher->resize(640, 480);
        Teacher->setMinimumSize(QSize(640, 480));
        Teacher->setMaximumSize(QSize(640, 480));
        tableView = new QTableView(Teacher);
        tableView->setObjectName(QString::fromUtf8("tableView"));
        tableView->setGeometry(QRect(20, 20, 588, 324));
        widget = new QWidget(Teacher);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(20, 390, 588, 41));
